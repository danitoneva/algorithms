...
### Instalation 
1. Clone the repo 
    git clone https://github.com/danitoneva/my_math_project.git

## Tests 

To run the unittests in the test directory run the following command:
    python -m unittest /path to the file/

To run the pytests in the test directory run the following command:
    python -m pytest /path to the file/