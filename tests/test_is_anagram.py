...
"""
import unittest
from src.is_anagram import AnagramModule
...
class TestAnagramModule(unittest.TestCase):
    ...
    def test_two_strings_anagrams(self):
        ...
        actual_result = AnagramModule.is_anagram(string1= "string", string2= "irgnts")
    ...
    def test_two_strings_anagrams_with_space(self):
        ...
        actual_result = AnagramModule.is_anagram(string1= "st ring", string2= "string")
        self.assertEqual(expected_result, actual_result)

    def test_two_strings_anagrams_with_space_and_capital(self):
        expected_result = False
        actual_result = AnagramModule.is_anagram(string1= "sT ring", string2= "stRi ng")
        self.assertEqual(expected_result, actual_result)
